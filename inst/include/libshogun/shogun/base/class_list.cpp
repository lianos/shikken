...
#include "preprocessor/ClassicIsomap.h"
...
static CSGObject* __new_CClassicIsomap(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CClassicIsomap(): NULL; }
static CSGObject* __new_CClassicMDS(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CClassicMDS(): NULL; }
static CSGObject* __new_CKernelPCACut(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CKernelPCACut(): NULL; }
static CSGObject* __new_CLandmarkIsomap(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CLandmarkIsomap(): NULL; }
static CSGObject* __new_CLandmarkMDS(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CLandmarkMDS(): NULL; }
static CSGObject* __new_CLocallyLinearEmbedding(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CLocallyLinearEmbedding(): NULL; }
static CSGObject* __new_CPCACut(EPrimitiveType g) { return g == PT_NOT_GENERIC? new CPCACut(): NULL; }
...
#ifdef HAVE_LAPACK
{m_class_name: "LDA", m_new_sgserializable: __new_CLDA},
{m_class_name: "DomainAdaptationSVMLinear", m_new_sgserializable: __new_CDomainAdaptationSVMLinear},
{m_class_name: "LibLinear", m_new_sgserializable: __new_CLibLinear},
{m_class_name: "Tron", m_new_sgserializable: __new_CTron},
{m_class_name: "GMM", m_new_sgserializable: __new_CGMM},
{m_class_name: "Gaussian", m_new_sgserializable: __new_CGaussian},
{m_class_name: "ClassicIsomap", m_new_sgserializable: __new_CClassicIsomap},
{m_class_name: "ClassicMDS", m_new_sgserializable: __new_CClassicMDS},
{m_class_name: "LandmarkMDS", m_new_sgserializable: __new_CLandmarkMDS},
{m_class_name: "KernelPCACut", m_new_sgserializable: __new_CKernelPCACut},
{m_class_name: "LandmarkIsomap", m_new_sgserializable: __new_CLandmarkIsomap},
{m_class_name: "LocallyLinearEmbedding", m_new_sgserializable: __new_CLocallyLinearEmbedding},
{m_class_name: "PCACut", m_new_sgserializable: __new_CPCACut},
{m_class_name: "KRR", m_new_sgserializable: __new_CKRR},
